...
from app.models.source_operator import SourceOperatorConfig  # noqa

config = context.config

# ВАЖНО: подставляем один и тот же URL, что и в приложении
...
def run_migrations_offline() -> None:
    """Offline migrations (без подключения)."""
...
def do_run_migrations(connection) -> None:
    """Функция для sync-части, которую дергаем через run_sync."""
    context.configure(
